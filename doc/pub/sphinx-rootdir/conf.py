# -*- coding: utf-8 -*-
#
# Using Web Frameworks for Scientific Applications documentation build configuration file, created by
# sphinx-quickstart on Fri Sep 26 13:02:57 2014.
#
...
project = u'Using Web Frameworks for Scientific Applications'
...
html_title = "Using Web Frameworks for Scientific Applications"
...
htmlhelp_basename = 'UsingWebFrameworksforScientificApplicationsdoc'
...
latex_documents = [
  ('index', 'UsingWebFrameworksforScientificApplications.tex', u'Using Web Frameworks for Scientific Applications Documentation',
...
man_pages = [
    ('index', 'usingwebframeworksforscientificapplications', u'Using Web Frameworks for Scientific Applications Documentation',
...
texinfo_documents = [
  ('index', 'UsingWebFrameworksforScientificApplications', u'Using Web Frameworks for Scientific Applications Documentation',
   u'H. P. Langtangen and A. E. Johansen', 'UsingWebFrameworksforScientificApplications', 'One line description of project.',
   'Miscellaneous'),
]
